...
| `cloudspire-citadel` | Cloudspire Citadel | IMPLEMENTED WORLD | `grok/cloudspire-citadel` | `.claude/worktrees/grok+cloudspire-citadel` | Grok | not merged | high | Generator preset + 242-chunk bake; materials 42–48; optional atmosphere meta; PR pending |
