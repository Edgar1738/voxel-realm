...
| `ember-spire`           | Ember Spire             | IMPLEMENTED WORLD    | `agent/voxel-realm-priorities` (origin: `grok/ember-spire`) | current worktree                                  | Grok                             | pushed in draft PR #76      | high       | Formerly `ashen-reach`; source reconciled from `6034734`, registered as a preset, tested, benchmarked, and packaged as VRW1 after Edgar's 2026-08-01 authorization                            |
