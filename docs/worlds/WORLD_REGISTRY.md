...
| `hollowmere` | Hollowmere | WORLD IN REVIEW | `grok/hollowmere` | `.claude/worktrees/grok+hollowmere` | Grok | not merged | high | M1 complete/frozen: living village around flooded lost village + distant volcano + Drowned Bell Tower. Preset `hollowmere`. Screenshots in `experimental/hollowmere/screenshots-m1/`. Awaiting Edgar visual review. |
