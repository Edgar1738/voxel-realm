/**
 * Caldera Gate District â€” Milestone 2 densification of the north-shore settlement.
...
export function buildGateDistrict(s: CitadelStamp, seed: WorldSeed): void {
  // Main ceremonial avenue paving (xâ‰ˆ4..12, z from gate to plaza).
  for (let z = -26; z <= 22; z++) {
    for (let x = 4; x <= 12; x++) {
  ...
  // Civic buildings â€” varied footprints and heights.
