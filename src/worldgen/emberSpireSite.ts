...
import { buildArrivalTunnel, buildCraterGate, buildGateDistrict } from './emberSpireDistrict';
...
// â”€â”€ Frame â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const VY = ASHEN.village.benchY; // 68 â€” district deck level
...
// â”€â”€ Plaza flagstones (overlaid under Gate District avenues) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Ember path: plaza â†’ shore â†’ fissure bridge â†’ rim climb â†’ observatory â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function stairRoadClimbs(s: CitadelStamp, seed: WorldSeed): void {
  for (let i = 0; i < ASHEN_ROAD.length - 1; i++) {
    ...
    for (let k = 0; k <= steps; k++) {
      ...
      if (hNext > h) {
        // Climbing toward +z or +x of the segment â€” face stairs uphill.
        const dx = b.x - a.x;
        const dz = b.z - a.z;
        const face =
...
// â”€â”€ Magma fissure + ash bridge â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function buildFissureAndBridge(s: CitadelStamp): void {
  ...
  for (let z = cz - halfLen; z <= cz + halfLen; z++) {
    for (let x = cx - halfW; x <= cx + halfW; x++) {
      const edge = Math.max(Math.abs(x - cx) / halfW, Math.abs(z - cz) / halfLen);
  ...
  // Stone bridge deck spanning the fissure northâ€“south at shore height + 1.
  const deckY = SHORE + 2;
  const x0 = cx - halfW - 2;
  const x1 = cx + halfW + 2;
...
// â”€â”€ Ember vents around the lake â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Shore dock â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function buildShoreDock(s: CitadelStamp, seed: WorldSeed): void {
  ...
  // Vista-corridor lanterns at player height â€” atmospheric path markers, not aerial clutter.
...
function buildCalderaOverlook(s: CitadelStamp): void {
  ...
  // Two framing pillars either side of the gap â€” composition anchors at player height.
  for (const x of [4, 12]) {
...
/**
 * Walkable causeway: dock â†’ Ember Spire island. Hero is reachable on foot (swim optional, not
...
function buildSpireCauseway(s: CitadelStamp, seed: WorldSeed): void {
  ...
  const deckY = SEA_LEVEL + 1; // 63 â€” above water, matches shore
  ...
  // Island landing pad north of the spire door â€” rocky apron so the tower is framed by ground.
  ...
  // Ember crystals along the landing edge â€” atmospheric detail at foot level.
  for (const [dx, dz] of [
    [-3, -8],
    [3, -8],
    [-2, -6],
...
// â”€â”€ Observatory on the west rim â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Sparse outer wilds only (no random scatter in the district) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
function buildWilds(s: CitadelStamp, seed: WorldSeed): void {
  stampPrefab(s, obelisk(), 8, ashenSurfaceAt(seed, 8, 160) + 1, 160);
  // Few dead trees only outside the rim â€” intentional markers, not scatter fill.
  for (const [tx, tz] of [
    [-120, 40],
    [110, 80],
    [-30, 190],
...
// â”€â”€ Dockside sandbar & lake edge polish â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
 ...
 * Arrival tunnel â†’ Crater Gate â†’ Gate District â†’ lakefront â†’ ceremonial causeway â†’
